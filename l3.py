...
#PART 2: Store the agent's details using different ddata types
agent_number = 7
speed_rating = 9.5
mission_count = 12
height_m = 1.65
...
#PART 4: Typecast the number and true/false value into text
...
print("Speed Rating as text:", speed_rating, "-> type:",
type(speed_rating_text))
print("Status as text:", status_text, "-> type:",
type(status_text))
